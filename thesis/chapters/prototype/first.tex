...
\noindent
Die Komponente des \emph{Datenmodells} sah dabei wie folgt aus (eine vollständige Version des UML-Diagramms befindet sich im Anhang \todo{in Anhang packen}):
...
\noindent
Eine weitere Klasse im \emph{Datenmodell} ist \emph{UserAction} (\todo{ref auf Anhang}).
...
Zum Testen des Prototyps wurde dieser in die App der beiden Geschäftsführer von \vr{} (siehe \autoref{table:testers}) eingebunden.
