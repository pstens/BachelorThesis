...
Die \mg{} suggerieren zur Umsetzung eines solchen ``Onboarding''-Prozesses\urlnote{https://material.io/guidelines/growth-communications/onboarding.html\#onboarding-onboarding-models}{15.01.2018} drei verschiedene Ansätze (vgl. \autoref{fig:onboarding}). \\
...
Umgesetzt wurde die \emph{Quickstart} Variante mit Hilfe sogenannter \emph{Tap targets}\urlnote{https://material.io/guidelines/growth-communications/feature-discovery.html\#feature-discovery-design}{16.01.2018}.
...
Die verwendete \emph{Android-Library} für den Farbauswahl-Dialog\urlnote{https://github.com/jaredrummler/ColorPicker}{16.01.2018} verfügt bereits über einen ``Preset-Mode'', welcher es ermöglicht, anstatt des gesamten Farbkreises nur eine Farbpalette mit den häufigst genutzten Farben anzuzeigen.
...
Im Gerüsttyp-Dialog wurden \emph{AutoCompleteTextField}-Elemente\urlnote{https://developer.android.com/reference/android/widget/AutoCompleteTextView.html}{17.01.2018} benutzt, welche die eingetragenen Messwerte der Form beim Tippen vorschlagen.
