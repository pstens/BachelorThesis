...
Die App \im{} von \emph{Dirk Farin} hat zur Zeit des Downloads (30. November 2017, Version \emph{2.14.3}) bei insgesamt 2 768 abgegeben Bewertungen eine durchschnittliche Bewertung von 3,9 von 5 Sternen im Google Play-Store\urlnote{https://play.google.com/store/apps/details?id=de.dirkfarin.imagemeter}{30.11.2017}.
...
\begin{figure}[h]
  \begin{subfigure}[t]{0.3\textwidth}
    \centering
    \includegraphics[keepaspectratio, width=\textwidth]{image_meter/tip}
...
\begin{wrapfigure}{R}{0.4\textwidth}
  \centering
  \includegraphics[keepaspectratio, width=0.4\textwidth]{image_meter/faq}
...
Die Idee der Verwendung eines ``Tipp des Tages'' ist sinnvoll um den Nutzer schrittweise an die Bedienung der App heranzuführen, wurde bei dieser App jedoch nicht optimal umgesetzt.
...
\begin{wrapfigure}{R}{0.4\textwidth}
  \centering
  \includegraphics[keepaspectratio, width=0.4\textwidth]{image_meter/bar}
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio, width=0.8\textwidth]{image_meter/landscape}
...
Hier kann der Benutzer mit Hilfe einer \emph{Pinch-} oder \emph{Doppelklick-Geste}\urlnote{https://page-online.de/tools-technik/multitouch-infografik/}{30.11.2017} in das Bild herein- bzw. herauszuzoomen.
...
\begin{wrapfigure}{R}{0.4\textwidth}
  \centering
  \includegraphics[keepaspectratio, width=0.4\textwidth]{image_meter/lensebug}
