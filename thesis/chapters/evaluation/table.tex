\begin{sidewaystable}[ht]
  ...
  \begin{tabular}{|r|l|c|c|c|}
    ...
    & \hyperref[itm:N4]{4. Konsistenz und Standards} 				&       \po  		&    \po			&       \xmark    \\ \cline{2-5}
    & \hyperref[itm:N5]{5. Fehlervorbeugung} 				&       \po  		&    \po			&       \po       \\ \cline{2-5} 
    & \hyperref[itm:N6]{6. Wiedererkennung statt Erinnern} 				&       \po 		&    \xmark		&       \xmark    \\ \cline{2-5} 
    ...
    & \hyperref[itm:N12]{12. Fokussieren von Informationen} 			&       \po   	&    \po 			&       \xmark    \\ \cline{2-5} 
    & \hyperref[itm:N13]{13. ``Joy of Use''}			 	&       \xmark  &    \po  		&       \po       \\ \cline{2-5} 
