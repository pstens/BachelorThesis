...
Zudem sollen bei der Auswahl der Apps verschiedene Kriterien berücksichtigt werden
So achtet, nach einer Studie aus dem Jahr 2014 von \citeauthor{Dogruel14}, in der 49 Smartphone-Nutzer bei ihrer Entscheidungsfindung zum Download von Apps aus dem Google-Play Store beobachten wurden, ein Großteil (74\%) der Testpersonen auf eine gute Bewertung der App wert.
33\% der Testpersonen stützen sich laut \citeauthor{Dogruel14} bei ihrer Entscheidungsfindung außerdem auch noch auf die Rezensionen über die App.
Für 9\% der Testpersonen sei die Anzahl der Downloads bzw. die Popularität der Applikation mit entscheidend \citep{Dogruel14}. \\

Um die Lösungsalternativen möglichst repräsentativ zu wählen, wurden Apps ausgewhält, die jeweils eines der oben genannten Auswahlkriterien besonders gut erfüllt. \todo{anders formulieren}
Bei den ausgewählten Apps handelt es sich um folgende:
\todo{eventuell M\&S}  auswechseln gegen ImageMeter (Bewertung & Downloads)

\begin{itemize}
  \item \mm{} - Bosch GmbH (\textit{Popularität})
  \item \ms{} - SameBits (\textit{Downloads})
  \item \pm{} - Blue Big Pixel Inc. (\textit(Rezensionen))
\end{itemize}

\noindent
\todo{Quellen} 
Die App \mm{} der Bosch GmbH stammt von einem internationalen Großkonzern mit mehr als 80 Standorten in Deutschland, und einem Jahresumsatz von 14,5 Mrd. Euro.
Mit seinen 100.000 bis 500.000 Installationen gehört die App zu einer der populärsten unter dem Suchbegriff ``Aufmaße''. \\

\ms{} von SameBits wurde gewählt, da sie mit einer Gesamtbewertung von 3.6 von 5 Sternen bei 1.781 abgegebenen Bewertungen eine der beliebtesten Apps unter dem Suchbegriff ``Aufmaße'' ist.
Dabei handlet es sich bei 41\% (726) dieser Bewertungen um Bewertungen mit fünf Sternen und bei 18$\% (313) um Bewertungen mit nur einem Stern. \\

\todo{Photo measures weil beste Bewertung und Rezensionen}
...
\input{chapters/evaluation/measure_sketch}
