...
Die Integrationsfähigkeit der Apps wurde mit Hilfe zweier vom Unternehmen \vr{} aufgestellter Kriterien zum Export der Meta-Daten und deren späteren Weiterverarbeitung evaluiert.
...
Die beiden Apps \mm{} und \pm{} schnitten im Vergleich zu \im{} bzgl. der Usability-Heuristiken schlecht ab.
...
Hier fehlte jedoch eine Hilfestellung zur eigentlichen Benutzung der Zeichen-Funktion beim initialen Start.
...
Schlüsselveränderungen zwischen dem Prototyp aus der ersten und vierten Iteration liegen vor allem in einer vereinfachten und intuitiveren Benutzeroberfläche.
...
Hierdurch können Mitarbeiter direkt auf die Informationen zugreifen, ohne diese zuerst im Büro ins System eintragen zu müssen.
...
\emph{Google} hat passend dazu auf dem \emph{GSMA Mobile World Congress 2018} die \emph{AR}-Plattform \emph{ARCore} offiziell gestartet.
...
Einen guten Ausblick auf das, was mit \emph{ARCore 1.0} bereits möglich ist, bietet die App \emph{AirMeasure}\urlnote{http://armeasure.com/\#features}{05.03.2018}. 
