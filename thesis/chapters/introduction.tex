...
Die App kommuniziert zur Synchronisation der gesammelten Daten mit einer Server-Schnittstelle (\emph{API}\urlnote{https://www.gruenderszene.de/lexikon/begriffe/application-programming-interface-api}{22.11.2017}), welche auch von \vr{} entwickelt wurde.
