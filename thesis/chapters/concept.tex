...
\todo{Ich bin mit diesem Kapitel nicht zufrieden, aber weiß auch nicht, was ich noch großartig anders machen soll}
\todo{Brauche ich hier papers/literatur für die Entscheidungen?}
...
\begin{wrapfigure}{R}{0.5\textwidth}
  \centering
  \includegraphics[keepaspectratio, width=0.5\textwidth]{concept/fab}
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio, height=0.5\textheight]{concept/lifecycle}
...
\todo{Hierzu irgendein paper finden?}
