...
Der Fokus dieser Arbeit liegt in der Entwicklung einer effizienten und robusten Software-Lösung in Form einer Android-App für die Aufmaßerfassung im Gerüstbau.
Der bisherige Prozess der Aufmaßerfassung hat sich als fehleranfällig und aufwändig herausgestellt.
Im folgenden Kapitel wird am Beispiel der \emph{Fa.} \vr{} dieser bisherige, analoge Prozess der Aufmaßerfassung illustriert.
...
In diesem Kapitel wird der charakteristische Vorgang der Aufmaßerfassung im Gerüstbau zunächst beschrieben und anschließend werden Fehlerquellen, die sich in der Vergangenheit gezeigt haben, evaluiert. \\
...
\noindent
Durch zu grobe Schätzungen, Medienbrüche\urlnote{https://www.itwissen.info/Medienbruch-media-disruption.html}{25.11.2017}, aber auch die hohe kognitive Belastung der Monteure, kommt es bei der Aufmaßerfassung immer wieder zu Fehlern und damit Kosten, die sich durch eine effizientere Informationsverarbeitung vor Ort auf den Baustellen vermeiden lassen. \\
...
In \autoref{fig:problem} sind die Aufmaße eines Fassadengerüst vom 22. November 2017 zu sehen.
...
\begin{itemize}
  ...
  \item Wie setzt man eine Bearbeitungsumgebung auf einem Smartphone oder Tablet um, die dem Benutzer intuitiv alle möglichen Bearbeitungsoptionen aufzeigt, das Bild dennoch zu jeder Zeit gut erkennbar bleibt?
...
\noindent
Die theoretische und praktische Beantwortung dieser Fragen wird in den nachfolgenden Kapiteln weiter ausgeführt.
